...
class _ApiService implements ApiService {
  ...
  Future<AddOfferResponse> addOfferToCatalog(
    ...
    final _options = _setStreamType<AddOfferResponse>(
    ...
    late AddOfferResponse _value;
    try {
      _value = AddOfferResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<AddStockResponse> addStock(Map<String, dynamic> request) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AddStockResponse _value;
    try {
      _value = AddStockResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<ActiveOffersResponse> getActiveOffers() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ActiveOffersResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'catalog?is_active=1&per_page=15',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ActiveOffersResponse _value;
    try {
      _value = ActiveOffersResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<LedgerResponse> getLedger(int page) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'page': page};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<LedgerResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'ledger',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late LedgerResponse _value;
    try {
      _value = LedgerResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<OrdersResponse> getOrders(String status, int perPage) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{
      r'status': status,
      r'per_page': perPage,
  ...
  @override
  Future<GetStockResponse> getStock() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetStockResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'inventory',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetStockResponse _value;
    try {
      _value = GetStockResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<StoreProductDetailResponse> getStoreProduct(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<StoreProductDetailResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'products/${id}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late StoreProductDetailResponse _value;
    try {
      _value = StoreProductDetailResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<StoreProductsResponse> getStoreProducts(int page) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'page': page};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<StoreProductsResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'products',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late StoreProductsResponse _value;
    try {
      _value = StoreProductsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
